          ...
          <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
            ...
            <div className="mt-12">
              ...
              <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                Bạn chưa có tài khoản ? <NavLink to="/dangky" className="cursor-pointer text-indigo-600 hover:text-indigo-800">Đăng ký</NavLink>
              </div>
            </div>
          </div>
        </form>
        <div className="hidden lg:flex items-center justify-center flex-1 h-screen" style={{ height: height, width: width / 2, backgroundImage: `url(https://picsum.photos/2000`, backgroundSize: '100%' }}>
          </div>
      </div>
  )
}
